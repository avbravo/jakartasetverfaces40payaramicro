...
public class DemoFacelet extends Facelet {
    ...
    public void apply(FacesContext facesContext, UIComponent root) throws IOException {
        ...
        UIOutput output_boot = new UIOutput();

        output_boot.setValue("<script src=\"/webjars/bootstrap/js/bootstrap.min.js\"></script>");
        rootChildren.add(output_boot);
        ...
        */
        ...
        actionButton.setStyleClass("btn btn-primary");
